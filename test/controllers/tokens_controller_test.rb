...
class TokensControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create token" do
    assert_difference('Token.count') do
      post tokens_url, params: { token: { create: @token.create, destroy: @token.destroy, new: @token.new } }
    end
  ...
  test "should update token" do
    patch token_url(@token), params: { token: { create: @token.create, destroy: @token.destroy, new: @token.new } }
