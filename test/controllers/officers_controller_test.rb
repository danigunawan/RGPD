...
class OfficersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create officer" do
    assert_difference('Officer.count') do
      post officers_url, params: { officer: { email: @officer.email, firstname: @officer.firstname, lastname: @officer.lastname, password: 'secret', password_confirmation: 'secret' } }
    end
  ...
  test "should update officer" do
    patch officer_url(@officer), params: { officer: { email: @officer.email, firstname: @officer.firstname, lastname: @officer.lastname, password: 'secret', password_confirmation: 'secret' } }
