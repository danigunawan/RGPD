...
class ModificationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create modification" do
    assert_difference('Modification.count') do
      post modifications_url, params: { modification: { address: @modification.address, city: @modification.city, email: @modification.email, name: @modification.name, phone: @modification.phone, string: @modification.string, surname: @modification.surname, zipcode: @modification.zipcode } }
    end
  ...
  test "should update modification" do
    patch modification_url(@modification), params: { modification: { address: @modification.address, city: @modification.city, email: @modification.email, name: @modification.name, phone: @modification.phone, string: @modification.string, surname: @modification.surname, zipcode: @modification.zipcode } }
